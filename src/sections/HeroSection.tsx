...
export default function HeroSection() {
    ...
    const form = (
        <FormCard>
            ...
            <DropdownField
                label={profileFor || "Profile created for"}
                open={profileOpen}
            ...
            <DropdownField
                ...
                label={
                    <span className="flex flex-col">
                        <span className="text-[12px] leading-[1.2] text-[#6C6C6C] mb-0.5">Country code</span>
    ...
    transition hover:opacity-85 active:scale-[0.99] cursor-pointer"
            ...
            <p className="text-center text-[12px] leading-[1.5] text-[#666666]">
                Takes 2 minutes. 100% Data Privacy Guaranteed.
            </p>
        </FormCard>
    );
    ...
    return (
        ...
        Desktop (lg+):  fixed 658px, form lives INSIDE the overlay
        Mobile/tablet:  auto height, only badge + headline inside; form below
      */}
      ...
      text-[20px] sm:text-[24px] md:text-[28px] lg:text-[32px]">
                                        Find your perfect partner who shares your culture & future.
                                    </h1>
                                    <p className="text-[14px] leading-[1.5] text-white/85 md:text-[16px]">
                                        100% verified profiles. From the homeland to the global diaspora.
                                    </p>
                                </div>
                            </div>
            ...
            {/* ── Trust bar ── */}
            <div className="mt-15 mb-15 px-6 xl:px-[170px]">
                <div className="grid grid-cols-2 gap-y-6 gap-x-4 md:grid-cols-3 items-center">
...
function TrustItem({ icon, text }: { icon: React.ReactNode; text: string }) {
    return (
        <div className="flex items-center gap-2 text-[13px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] font-medium text-[#222222]">
            {icon}
            <span>{text}</span>
        </div>
    );
