...
//                   </>
//                 ) : !isElite ? (
//                   <span className="font-14 font-semibold text-[#B31B38] leading-none">
//                     Upgrade
//                   </span>
//                 ) : (
//                   <span className="font-14 font-semibold text-[#8D5900] leading-none">
//                     Elite
//                   </span>
//                 )}
//               </div>
  ...
  return (
    <>
        ...
        <div className="max-w-[1920px] mx-auto flex px-5 lg:px-10 h-[74px] pt-5 gap-5 min-[900px]:gap-6">
          ...
          <div className="flex items-center gap-3 flex-1 justify-end">
            ...
            <div className="hidden min-[900px]:relative mb-2 min-[900px]:flex items-center">
              ...
              >
                <div className="w-8 h-8 rounded-full overflow-hidden border border-white bg-[#D9D9D9] relative">
                  <Image src={photo} fill className="object-cover" alt="my profile" sizes="32px" />
                </div>
                <div className="flex flex-col gap-1">
                  {!trustBadge ? (
                    <>
      ...
      {/* ══════════════════════════════════════════════════════
          ...
          - Backdrop: z-[55], blurs/dims page content
          - Drawer:   z-[60], slides in from the right
          Both are outside <header> so they sit above the sticky bar
          ══════════════════════════════════════════════════════ */}
