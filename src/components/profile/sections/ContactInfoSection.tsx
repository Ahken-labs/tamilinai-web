...
export default function ContactInfoSection({ me }: Props) {
  ...
  return (
    <div className="font-poppins">
      {/* WhatsApp / Phone */}
      <div className="border-t border-[#EAEAEA] pt-3 md:pt-4 flex w-full justify-between items-start gap-2">
        <div className="text-secondary3 font-16 shrink-0">WhatsApp</div>
        <div className="flex items-center gap-2 md:gap-3 flex-wrap justify-end">
          <span className="font-16 text-[#767676] select-none">{phone}</span>
          {isPhoneVerified ? (
      ...
      {/* Email */}
      <div className="mt-3 md:mt-4 flex w-full justify-between items-start gap-2">
        <div className="text-secondary3 font-16 shrink-0">Email</div>
        <div className="flex items-center gap-2 md:gap-3 flex-wrap justify-end">
          <span className="font-16 text-[#767676] select-none">{email}</span>
          {isEmailVerified ? (
            <div className="flex shrink-0 items-center gap-[2px] rounded-[41px] bg-[#F0F0F0] py-[2px] pl-3 pr-2">
              <span className="font-16 font-normal leading-[150%] text-[#656565]">Verified</span>
