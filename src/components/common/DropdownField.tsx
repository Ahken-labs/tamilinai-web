...
//                 className={`flex w-full items-center justify-between rounded-[12px] border ${open ? (openBorderClassName ?? borderClassName ?? "border-[#F2F2F2]") : (borderClassName ?? "border-[#F2F2F2]")
//                     } bg-[#F2F2F2] pl-4 pr-[18px] py-[10px] text-left transition-colors cursor-pointer focus:outline-none ${className}`}
//             >
...
//                                     setOpen(false);
//                                 }}
//                                 className={`flex w-full items-center px-4 py-2 md:py-3 text-left text-[15px] transition-colors
//                 ${isSelected
//                                         ? "bg-[#FFF0F3]"
...
export default function DropdownField({
  ...
  return (
    <div className={`relative ${className}`}>
      {typeable ? (
        <div
          className={`flex h-[55px] md:h-[60px] items-center rounded-[12px] border bg-[#F2F2F2] px-4 transition-colors ${borderClass}`}
        >
        ...
        >
          <span
            className={`text-[14px] md:text-[16px] font-normal leading-[125%] ${
